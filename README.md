...
Relational Databases store data in tables with columns representing attributes of a record and rows representing the records themselves. SQL is the language used to interact with an manipulate the data in a relational database.
...
We need a third table to act as an intermediary.
